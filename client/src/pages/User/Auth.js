        ...
        <div className="wrapper">
            <div className="forms-container">
                ...
                <form onSubmit={signInSubmitHandler} action="#" className="sign-in-form">
                    ...
                    <i class="fas fa-at"></i>
                    <input onChange={signInEmailHandler} type="text" placeholder="Email" />
                    </div>
                    <div className="input-field">
                    <i className="fas fa-lock"></i>
                    <input onChange={signInPasswordHandler} type="password" placeholder="Password" />
                    </div>
                ...
                <form onSubmit={signUpSubmitHandler} action="#" className="sign-up-form">
                    ...
                    <input onChange={fullNameHandler} type="text" placeholder="Full Name" />
                    </div>
                    <div className="input-field">
                    <i class="fas fa-at"></i>
                    <input onChange={emailHandler} type="email" placeholder="Email" />
                    </div>
                    <div className="input-field">
                    <i className="fas fa-lock"></i>
