...
import {
  getUserData,
  getUserData2,
} from "../../helpers/AuthHelpers/GetUserData";
    ...
    try {
      ...
      if (result.status !== 200) {
        ...
        if (result.data.data.login === null) {
          ...
          const userDataResult = await getUserData2(tempToken);
          if (
            userDataResult.data.data.getUserData.personalProfile !==
              undefined &&
            userDataResult.data.data.getUserData.personalProfile !== null
          ) {
